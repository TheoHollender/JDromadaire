...
public class AsinFunction extends FunctionNode {

	public AsinFunction(int col, int line) {
		super(col, line);
	}
	...
	public Object evaluate(VariableContext context, ArrayList<Object> args) {
		...
		return new NumberNode(Math.round(10000000000d*Math.asin(nb))/10000000000d,col,line);
	}
