...
public class LogFunction extends FunctionNode {

	public LogFunction(int col, int line) {
		super(col, line);
	}
	...
	public Object evaluate(VariableContext context, ArrayList<Object> args) {
		...
		return new NumberNode(Math.round(10000000000d*Math.log10(nb))/10000000000d,col,line);
	}
